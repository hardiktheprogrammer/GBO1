! function(e) {
    ...
    90: function(e, t, n) {
        ...
        window.isEditMode = !1, window.ea = {
            ...
            })), f = jQuery, ea.getToken = function() {
                localize.nonce && !ea.noncegenerated && (ea.noncegenerated = !0, f.ajax({
                ...
                var t, n = f(this).attr("href");
                (t = (n = void 0 === n ? "" : n).startsWith("#")) || (t = (n = n.replace(localize.page_permalink, "")).startsWith("#"));
                try {
                    t && (f(n).hasClass("eael-tab-item-trigger") || f(n).hasClass("eael-accordion-header")) && f(n).trigger("click")
                } catch (e) {}
            })),
            function(e) {
