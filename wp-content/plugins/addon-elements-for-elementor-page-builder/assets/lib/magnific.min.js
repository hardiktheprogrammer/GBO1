! function(e) {
    ...
    var t, n, o, i, a, r, s = "Close",
        ...
        I = function(n, o) {
            t.ev.triggerHandler(p + n, o), t.st.callbacks && (n = n.charAt(0).toLowerCase() + n.slice(1), t.st.callbacks[n] && t.st.callbacks[n].apply(t, e.isArray(o) ? o : [o]))
        },
        x = function(n) {
    ...
    v.prototype = {
        ...
        open: function(n) {
            ...
            if (!t.isOpen) {
                ...
                I("BeforeOpen"), t.st.showCloseBtn && (t.st.closeBtnInside ? (w(c, function(e, t, n, o) {
                    n.close_replaceWith = x(o.type)
                }), a += " eae-close-btn-in") : t.wrap.append(x())), t.st.alignTop && (a += " mfp-align-top"), t.fixedContentPos ? t.wrap.css({
        ...
        updateItemHTML: function() {
            ...
            var o = n.type;
            if (I("BeforeChange", [t.currItem ? t.currItem.type : "", o]), t.currItem = n, !t.currTemplate[o]) {
            ...
            t.appendContent(r, o), n.preloaded = !0, I(u, n), i = n.type, t.container.prepend(t.contentContainer), I("AfterChange")
        },
        appendContent: function(e, n) {
            t.content = e, e ? t.st.showCloseBtn && t.st.closeBtnInside && !0 === t.currTemplate[n] ? t.content.find(".eae-close").length || t.content.append(x()) : t.content = e : t.content = "", I("BeforeAppend"), t.container.addClass("mfp-" + n + "-holder"), t.contentContainer.append(t.content)
        },
        parseEl: function(n) {
            var o, i = t.items[n];
            if (i.tagName ? i = {
            ...
            return i.type = o || t.st.type || "inline", i.index = n, i.parsed = !0, t.items[n] = i, I("ElementParse", i), t.items[n]
        },
        ...
        _openClick: function(n, o, i) {
            if ((void 0 !== i.midClick ? i.midClick : e.eaePopup.defaults.midClick) || !(2 === n.which || n.ctrlKey || n.metaKey || n.altKey || n.shiftKey)) {
                var a = void 0 !== i.disableOn ? i.disableOn : e.eaePopup.defaults.disableOn;
                if (a)
                    if (e.isFunction(a)) {
        ...
        updateStatus: function(e, o) {
            if (t.preloader) {
                ...
                I("UpdateStatus", i), e = i.status, o = i.text, t.preloader.html(o), t.preloader.find("a").on("click", function(e) {
        ...
        _checkIfClose: function(n) {
            if (!e(n).hasClass(h)) {
                ...
                if (o && i) return !0;
                if (!t.content || e(n).hasClass("eae-close") || t.preloader && n === t.preloader[0]) return !0;
        ...
        _parseMarkup: function(t, n, o) {
            var i;
            o.data && (n = e.extend(o.data, n)), I(c, [t, n, o]), e.each(n, function(n, o) {
        ...
        registerModule: function(t, n) {
            n.options && (e.eaePopup.defaults[t] = n.options), e.extend(this.proto, n.proto), this.modules.push(t)
        },
        defaults: {
            disableOn: 0,
            key: null,
        ...
        if ("string" == typeof n)
            if ("open" === n) {
                var i, a = y ? o.data("magnificPopup") : o[0].magnificPopup,
                    r = parseInt(arguments[1], 10) || 0;
                a.items ? i = a.items[r] : (i = o, a.delegate && (i = i.find(a.delegate)), i = i.eq(r)), t._openClick({
                    mfpEl: i
                }, o, a)
            } else t.isOpen && t[n].apply(t, Array.prototype.slice.call(arguments, 1));
        else n = e.extend(!0, {}, n), y ? o.data("magnificPopup", n) : o[0].magnificPopup = n, t.addGroup(o, n);
        return o
    };
    var T, _, P, S = "inline",
        E = function() {
            ...
            getInline: function(n, o) {
                if (E(), n.src) {
                    ...
                    if (a.length) {
                        ...
                        r && r.tagName && (_ || (T = i.hiddenClass, _ = b(T), T = "mfp-" + T), P = a.after(_).detach().removeClass(T)), t.updateStatus("ready")
            ...
            getAjax: function(n) {
                ...
                var o = e.extend({
                    ...
                    success: function(o, i, a) {
                        ...
                        I("ParseAjax", r), t.appendContent(e(r.data), O), n.finished = !0, M(), t._setFocus(), setTimeout(function() {
                            t.wrap.addClass(m)
    ...
    e.eaePopup.registerModule("image", {
        options: {
            markup: '<div class="mfp-figure"><div class="eae-close"></div><figure><div class="mfp-img"></div><figcaption><div class="mfp-bottom-bar"><div class="mfp-title"></div><div class="mfp-counter"></div></div></figcaption></figure></div>',
        ...
        proto: {
            initImage: function() {
                var n = t.st.image,
                    o = ".image";
                t.types.push("image"), w(d + o, function() {
                ...
                var n = 0,
                    ...
                    i = function(a) {
                        L && clearInterval(L), L = setInterval(function() {
                            o.naturalWidth > 0 ? t._onImageHasSize(e) : (n > 200 && clearInterval(L), 3 === ++n ? i(10) : 40 === n ? i(50) : 100 === n && i(500))
                        }, a)
                    };
                i(1)
            },
            getImage: function(n, o) {
                var i = 0,
                    a = function() {
                        n && (n.img[0].complete ? (n.img.off(".mfploader"), n === t.currItem && (t._onImageHasSize(n), t.updateStatus("ready")), n.hasSize = !0, n.loaded = !0, I("ImageLoadComplete")) : ++i < 200 ? setTimeout(a, 100) : r())
                    },
                    r = function() {
                ...
                }, n), t.resizeImage(), n.hasSize ? (L && clearInterval(L), n.loadError ? (o.addClass("mfp-loading"), t.updateStatus("error", s.tError.replace("%url%", n.src))) : (o.removeClass("mfp-loading"), t.updateStatus("ready")), o) : (t.updateStatus("loading"), n.loading = !0, n.hasSize || (n.imgHidden = !0, o.addClass("mfp-loading"), t.findImageSize(n)), o)
            }
        }
    });
    var H;
            ...
            initZoom: function() {
                ...
                if (n.enabled && t.supportsTransition) {
                    var i, a, r = n.duration,
                        c = function(e) {
                            var t = e.clone().removeAttr("style").removeAttr("class").addClass("mfp-animated-image"),
                                ...
                                a = "transition";
                            return i["-webkit-" + a] = i["-moz-" + a] = i["-o-" + a] = i[a] = o, t.css(i), t
                        },
                        d = function() {
                    ...
                    w("BuildControls" + o, function() {
                        if (t._allowZoom()) {
                            if (clearTimeout(i), t.content.css("visibility", "hidden"), !(e = t._getItemToZoom())) return void d();
                            (a = c(e)).css(t._getOffset()), t.wrap.append(a), i = setTimeout(function() {
    ...
    e.eaePopup.registerModule(A, {
        options: {
            markup: '<div class="mfp-iframe-scaler"><div class="eae-close"></div><iframe class="mfp-iframe" src="//about:blank" frameborder="0" allowfullscreen></iframe></div>',
        ...
        proto: {
            ...
            getIframe: function(n, o) {
                ...
                var r = {};
                return a.srcAction && (r[a.srcAction] = i), t._parseMarkup(o, r, n), t.updateStatus("ready"), o
            }
        }
    });
    var j = function(e) {
        ...
        proto: {
            initGallery: function() {
                ...
                a += " mfp-gallery", w(d + i, function() {
                    ...
                    if (t.items.length > 1 && n.arrows && !t.arrowLeft) {
                        var o = n.arrowMarkup,
                            i = t.arrowLeft = e(o.replace(/%title%/gi, n.tPrev).replace(/%dir%/gi, "left")).addClass(h),
                            a = t.arrowRight = e(o.replace(/%title%/gi, n.tNext).replace(/%dir%/gi, "right")).addClass(h);
                        i.click(function() {
                            t.prev()
                        }), a.click(function() {
                            t.next()
            ...
            _preloadItem: function(n) {
                if (n = j(n), !t.items[n].preloaded) {
                    var o = t.items[n];
                    o.parsed || (o = t.parseEl(n)), I("LazyLoad", o), "image" === o.type && (o.img = e('<img class="mfp-img" />').on("load.mfploader", function() {
                        o.hasSize = !0
