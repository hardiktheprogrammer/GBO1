jQuery(window).on("elementor/frontend/init", (function() {
    elementorFrontend.hooks.addAction("frontend/element_ready/wts-gmap.default", (function(e) {
        map = function(a) {
            ...
            return s.markers = [], i.each((function() {
                    ! function(a, t) {
                        ...
                        $wrapper = e.find(".eae-markers");
                        var n = new google.maps.LatLng(a.attr("data-lat"), a.attr("data-lng"));
                        if (icon_img = a.attr("data-icon"), "" != icon_img) var r = {
                        ...
                        if (t.markers.push(s), a.html()) {
                            ...
                            "yes" == a.data("info-window") && d.open(t, s), google.maps.event.addListener(s, "click", (function() {
                                d.open(t, s)
                            }))
                        }
                ...
                function(e, a) {
                    ...
                    jQuery.each(e.markers, (function(e, a) {
                        var i = new google.maps.LatLng(a.position.lat(), a.position.lng());
                        t.extend(i)
                    })), 1 == e.markers.length ? (e.setCenter(t.getCenter()), e.setZoom(a)) : e.fitBounds(t)
                }(s, t), s
        }(e.find(".eae-markers"))
        ...
        c && c.data("eae-bg-slider") && (slider_images = c.data("eae-bg-slider"), a = c.data("eae-bg-slider-transition"), t = c.data("eae-bg-slider-animation"), n = ("yes" == (i = c.data("eae-bg-custom-overlay")) || c.data("eae-bg-slider-overlay"), eae_editor.plugin_url + "assets/lib/vegas/overlays/" + c.data("eae-bg-slider-overlay")), r = c.data("eae-bg-slider-cover"), s = c.data("eae-bs-slider-delay"), d = c.data("eae-bs-slider-timer"), "undefined" != typeof slider_images && (o = slider_images.split(","), jQuery.each(o, (function(e, a) {
            var t = [];
            t.src = a, l.push(t)
        })), c.vegas({
            slides: l,
            ...
            timer: d,
            init: function() {
                "yes" == i && c.children(".vegas-overlay").css("background-image", "")
            }
        })))
    }))
}));
...
! function(e) {
    e(window).on("elementor/frontend/init", (function() {
        var a = function(e, a) {
                function t(e) {
                    $icons = a(document).find(e).find(".eae-ic-icon-wrap"), window.innerWidth < 767 ? $icons.each((function(e, t) {
                        a(t).css("top", a(t).height() / 2 + 8 + "px"), a(t).next(".eae-info-circle-item__content-wrap").css("padding-top", a(t).height() / 2 + 8 + "px")
                    })) : $icons.each((function(e, t) {
                        a(t).css("margin-left", -.5 * a(t).outerWidth()), a(t).css("margin-top", -.5 * a(t).outerHeight()), $a = function(e) {
                            return e = (e - 90) * Math.PI / 180, {
                                x: 50 + 45 * Math.cos(e),
                                y: 50 + 45 * Math.sin(e)
                            }
                        }($angle), $b = 360 / $icons.length, a(t).css("left", $a.x + "%"), a(t).css("top", $a.y + "%"), $angle += $b
                    }))
                }
                $wrap_class = ".elementor-element-" + e.data("id"), $angle = 0, t(e);
                var i = null;

                function n() {
                    "yes" == e.find(".eae-info-circle").data("autoplay") && (i = setInterval(r, $autoplayDuration))
                }
                ...
                $autoplayDuration = e.find(".eae-info-circle").data("delay"), n(), e.find(".eae-ic-icon-wrap").hover((function() {
                    clearInterval(i)
                }), (function() {
                    n()
                })), e.find(".eae-info-circle-item").length > 0 && a(e.find(".eae-info-circle-item")[0]).addClass("eae-active"), e.find(".eae-ic-icon-wrap").on("click", (function() {
                    e.find(".eae-info-circle-item").removeClass("eae-active"), a(this).parent().addClass("eae-active")
            ...
            t = function(e, a) {
                function t() {
                    ...
                    var s = a(n).height(),
                        d = a(i).last().find(".eae-tl-icon-wrapper").offset().top - a(i[0]).parent().offset().top,
                        o = e.find(".eae-tl-icon-wrapper");
                    a(t).css("top", a(i[0]).find(".eae-tl-icon-wrapper").offset().top - a(i[0]).parent().offset().top), a(t).css("bottom", s - d), a(t).css("left", o.eq(0)[0].offsetLeft + o.eq(0).width() / 2), a(t).css("display", "block"), i.each((function(e, t) {
                        new Waypoint({
                            element: a(t),
                            handler: function(e) {
                                "down" == e ? a(t).addClass("eae-tl-item-focused") : a(t).removeClass("eae-tl-item-focused")
                            },
                            offset: r
                        })
                    }))
                }
                t(), window.addEventListener("resize", t), window.addEventListener("scroll", (function() {
                    e.find(".eae-timline-progress-bar");
                    const t = e.find(".eae-timeline").data("top-offset");
                    e.find(".eae-pb-inner-line").css("height", a(window).scrollTop() - e.find(".eae-timeline").offset().top + t), e.find(".eae-pb-inner-line").css("max-height", e.find(".eae-pb-inner-line").parent().height())
                }))
            };
        ...
        function n(e) {
            for (var a = e + "=", t = decodeURIComponent(document.cookie).split(";"), i = 0; i < t.length; i++) {
                for (var n = t[i];
        ...
        var r = function(e, a) {
                ...
                "skin1" === i && a(d).attr("style", "width : " + t + "%"), "skin2" === i && a(d).attr("style", "width : " + t + "%"), "skin3" === i && (a(r).addClass("eae-pb-bar-value--aligned-value"), $is_rtl ? a(r).attr("style", "right :" + t + "%") : a(r).attr("style", "left :" + t + "%"), a(d).attr("style", "width :" + t + "%")), "skin4" === i && (a(r).addClass("eae-pb-bar-value--aligned-value"), $is_rtl ? a(r).attr("style", "right :" + t + "%") : a(r).attr("style", "left :" + t + "%"), a(d).attr("style", "width :" + t + "%"), a(s).addClass("eae-pb-bar--no-overflow")), "skin5" === i && (a(r).addClass("eae-pb-bar-value--aligned-value"), $is_rtl ? a(r).attr("style", "right :" + t + "%") : a(r).attr("style", "left :" + t + "%"), a(d).attr("style", "width :" + t + "%")), $wrapper.each((function(e, t) {
                    new Waypoint({
                        ...
                        handler: function(e) {
                            "down" == e && (a(r).hasClass("js-animated") || a(r).addClass("js-animated"), a(d).hasClass("js-animated") || a(d).addClass("js-animated"), a(n).hasClass("js-animated") || a(n).addClass("js-animated"))
                        },
            ...
            d = function(e, a) {
                ...
                a(i).on("click", (function(e) {
                    a(this).find("input.eae-content-toggle-switch").is(":checked") ? (s.addClass("active"), l.addClass("active"), n.removeClass("active"), o.removeClass("active")) : (n.addClass("active"), o.addClass("active"), s.removeClass("active"), l.removeClass("active"))
                }))
            };
        e.fn.EAEHoverDirection = function(a) {
            ...
            this.find(".overlay").css({
                ...
                container = e(this), overlay = container.find(".overlay"), parentOffset = container.offset(), relX = a.pageX - parentOffset.left, relY = a.pageY - parentOffset.top, overlay.css({
                    top: 0,
                    left: 0,
                    width: container.width(),
                    height: container.height()
                }), relX > container.width() - t.inaccuracy ? overlay.css({
                    top: 0,
                    left: container.width()
                }) : relX < t.inaccuracy ? overlay.css({
                    top: 0,
                    left: -container.width()
                }) : relY > container.height() - t.inaccuracy ? overlay.css({
                    top: container.width(),
                    left: 0
                }) : relY < t.inaccuracy && overlay.css({
                    top: -container.width(),
                    left: 0
                }), overlay.animate({
                    top: 0,
                ...
                container = e(this), overlay = container.find(".overlay"), parentOffset = container.offset(), relX = a.pageX - parentOffset.left, relY = a.pageY - parentOffset.top, relX <= 0 && overlay.animate({
                    top: 0,
                    left: -container.width()
                }, t.speed), relX >= container.width() && overlay.animate({
                    top: 0,
                    left: container.width()
                }, t.speed), relY <= 0 && overlay.animate({
                    left: 0,
                    top: -container.height()
                }, t.speed), relY >= container.height() && overlay.animate({
                    left: 0,
                    top: container.height()
                }, t.speed)
            }))
        ...
        const l = function(e, a, t = null, i) {
                ...
                if (null !== t) {
                    a = t.data("id"), s = l + ' .eae-swiper-container[data-eae-slider-id="' + t.find(".swiper-container").data("eae-slider-id") + '"]'
                }
                if ("yes" === i.data("show-thumbnail")) {
                    const t = i.data("thumb-settings");
                    console.log("swiper data", e), console.log("In Condi", t), n = function(e, a, t, i) {
                        let n = {};
                        const r = {};
                        if (e.hasOwnProperty("mobile"))
                            for (const e in a) t.hasOwnProperty(e) && (n[e] = t[e].mobile);
                        return i && Object.keys(i).map(e => {
                            const a = parseInt(i[e]);
                            "desktop" === e && (e = "default");
                            const n = parseInt(t.spaceBetween[e]),
                                s = parseInt(t.slidesPerView[e]);
                            r[a - 1] = {
                                spaceBetween: n,
                                slidesPerView: s
                            }
                        }), n.breakpoints = r, n.direction = "horizontal", n.watchSlidesVisibility = !0, n.watchSlidesProgress = !0, n.freeMode = !0, n.slideToClickedSlide = !0, n
                    }(d, o, t, e.breakpoints_value), n.el = jQuery(".elementor-element-" + a + " .eae-thumb-container")
                }
                if (console.log("dfadfadfaf ==---\x3e", n), void 0 === e) return !1;
                if (r = {
                ...
                const f = {};
                if (e.hasOwnProperty("breakpoints_value") && Object.keys(e.breakpoints_value).map(a => {
                        const t = parseInt(e.breakpoints_value[a]);
                        "desktop" === a && (a = "default");
                        const i = parseInt(e.spaceBetween[a]),
                            n = parseInt(e.slidesPerView[a]),
                        ...
                        swiper: n
                    }, console.log("last swiper =-----\x3e", r), "undefined" == typeof Swiper) {
                    const t = elementorFrontend.utils.swiper;
                    console.log("swiper container", s), new t(jQuery(s), r).then(t => {
                        let i = t;
                        c(i);
                        const n = e.pause_on_hover;
                        "yes" == n && e.autoplay && p(i, n, a)
                    })
                } else {
                    const t = new Swiper(".elementor-element-" + a + " .eae-swiper-container", r);
                    c(t);
                    const i = e.pause_on_hover;
                    "yes" == i && p(t, i, a)
                }
                jQuery(".elementor-element-" + a + " .eae-swiper-container").css("visibility", "visible")
            },
            c = function(e) {
                e.length > 0 ? e.forEach((function(a) {
                    a.on("slideChangeTransitionStart", (function() {
                        ...
                        })), a.$wrapperEl.find(".swiper-slide-duplicate").find(".elementor-invisible").each((function() {
                            elementorFrontend.elementsHandler.runReadyTrigger(jQuery(this))
                        })), a.$wrapperEl.find(".swiper-slide").find(".animated").each((function() {
                            elementorFrontend.elementsHandler.runReadyTrigger(jQuery(this))
                        }))
                    })), a.on("click", (function() {
                        ...
                        if (null !== t && 0 != t.length) {
                            void 0 !== jQuery(t).data("ae-url") && (jQuery(t).data("ae-url") && jQuery(t).hasClass("ae-new-window-yes") ? window.open(jQuery(t).data("ae-url")) : location.href = jQuery(t).data("ae-url"))
                        }
                    })), a.init()
            ...
            p = function(e, a, t) {
                jQuery(".elementor-element-" + t + " .eae-swiper-container").hover((function() {
                    e.autoplay.stop()
                }), (function() {
                    e.autoplay.start()
                }))
            };
        elementorFrontend.hooks.addAction("frontend/element_ready/wts-ab-image.default", (function(e, a) {
            e.find(".eae-img-comp-container").imagesLoaded().done((function() {
                ab_style = e.find(".eae-img-comp-container").data("ab-style"), slider_pos = e.find(".eae-img-comp-container").data("slider-pos"), "horizontal" === ab_style ? (separator_width = parseInt(e.find(".eae-img-comp-overlay").css("border-right-width")), function(e) {
                    var a, t;
                    a = e.find(".eae-img-comp-overlay"), t = (t = a.width()) * slider_pos / 100,
                        function(a) {
                            var i, n, r, s = 0;

                            function d(e) {
                                e.preventDefault(), s = 1, window.addEventListener("mousemove", l), i.addEventListener("touchmove", c)
                            }
                            ...
                            function l(e) {
                                ...
                                (t = function(e) {
                                    var t;
                                    return e = e || window.event, t = a.getBoundingClientRect(), e.pageX - t.left
                                }(e)) < 0 && (t = 0), t > n && (t = n), p(t)
                            }
                            ...
                            function c(e) {
                                ...
                                (t = function(e) {
                                    var t;
                                    return t = a.getBoundingClientRect(), e.changedTouches[0].clientX - t.left
                                }(e)) < 0 && (t = 0), t > n && (t = n), p(t)
                            }

                            function p(e) {
                                a.style.width = e + "px", i.style.left = a.offsetWidth - i.offsetWidth / 2 - separator_width / 2 + "px"
                            }
                            n = a.offsetWidth, r = a.offsetHeight, a.style.width = t + "px", (i = (i = e.find(".eae-img-comp-slider"))[0]).style.top = r / 2 - i.offsetHeight / 2 + "px", i.style.left = t - i.offsetWidth / 2 - separator_width / 2 + "px", e.hasClass("elementor-element-edit-mode") || (i.addEventListener("mousedown", d), window.addEventListener("mouseup", o), i.addEventListener("touchstart", d), window.addEventListener("touchstop", o))
                        }(a[0])
                }(e)) : (separator_width = parseInt(e.find(".eae-img-comp-overlay").css("border-bottom-width")), function(e) {
                    var a;
                    a = e.find(".eae-img-comp-overlay"), start_pos = a.height(), start_pos = start_pos * slider_pos / 100,
                        function(a) {
                            var t, i, n, r = 0;

                            function s(e) {
                                e.preventDefault(), r = 1, window.addEventListener("mousemove", o), t.addEventListener("touchmove", l)
                            }
                            ...
                            function o(e) {
                                ...
                                (t = function(e) {
                                    var t, i = 0;
                                    return e = e || window.event, t = a.getBoundingClientRect(), i = e.pageY - t.top, i -= window.pageYOffset
                                }(e)) < 0 && (t = 0), t > n && (t = n), c(t)
                            }
                            ...
                            function l(e) {
                                ...
                                (t = function(e) {
                                    var t;
                                    return t = a.getBoundingClientRect(), e.changedTouches[0].clientY - t.top
                                }(e)) < 0 && (t = 0), t > n && (t = n), c(t)
                            }

                            function c(e) {
                                a.style.height = e + "px", t.style.top = a.offsetHeight - t.offsetHeight / 2 - separator_width / 2 + "px"
                            }
                            i = a.offsetWidth, n = a.offsetHeight, a.style.height = start_pos + "px", (t = (t = e.find(".eae-img-comp-slider"))[0]).style.top = start_pos - t.offsetHeight / 2 - separator_width / 2 + "px", t.style.left = i / 2 - t.offsetWidth / 2 + "px", e.hasClass("elementor-element-edit-mode") || (t.addEventListener("mousedown", s), window.addEventListener("mouseup", d), t.addEventListener("touchstart", s), window.addEventListener("touchstop", d))
                        }(a[0])
                }(e))
            }))
            ...
            $close_btn_type = e.find(".eae-popup-wrapper").data("close-button-type"), $close_btn = e.find(".eae-popup-wrapper").data("close-btn"), "icon" == $close_btn_type ? $close_btn_html = '<i class="eae-close ' + $close_btn + '"> </i>' : $close_btn_html = '<svg class="eae-close" style="-webkit-mask: url(' + $close_btn + "); mask: url(" + $close_btn + '); "></svg>', $magnific = e.find(".eae-popup-link").eaePopup({
                ...
                callbacks: {
                    beforeOpen: function() {
                        "" != t && (this.st.mainClass = "eae-popup eae-popup-" + e.find(".eae-popup-link").data("id") + " eae-wrap-" + e.find(".eae-popup-link").data("ctrl-id") + " mfp-" + t)
                    },
                    open: function() {
        ...
        })), elementorFrontend.hooks.addAction("frontend/element_ready/wts-testimonial-slider.default", (function(e, a) {
            ...
            if (e.find(".eae-layout-carousel").length) {
                ...
                var c = outer_wrapper.data("slides-per-view"),
                    ...
                    g = outer_wrapper.data("scrollbar");
                adata = {
                    direction: i,
                    effect: d,
                ...
                }, "fade" == d && (adata.fadeEffect = {
                    crossFade: !1
                }), adata.autoplay = "yes" == r && {
                    delay: s,
                    disableOnInteraction: !1
                }, "yes" == m && (adata.navigation = {
                    nextEl: ".swiper-button-next",
                    prevEl: ".swiper-button-prev"
                }), "" != f && (adata.pagination = {
                    el: ".swiper-pagination",
                    type: f
                }), "bullets" == f && "yes" == u && (adata.pagination = {
                    el: ".swiper-pagination",
                    clickable: !0,
                    type: f
                }), "yes" == g && (adata.scrollbar = {
                    el: ".swiper-scrollbar",
                    draggable: !0
                }), "yes" == h && (adata.keyboard = {
                    enabled: !0,
                    onlyInViewport: !0
                }), 0 == l && (adata.autoplay = {
                    delay: s,
                    stopOnLastSlide: !0,
                    disableOnInteraction: !1
                }), window.mswiper = new Swiper(".elementor-element-" + wid + " .eae-swiper-outer-wrapper .swiper-container", adata), a(".elementor-element-" + wid + " .eae-swiper-outer-wrapper .swiper-container").css("visibility", "visible")
            }
        })), elementorFrontend.hooks.addAction("frontend/element_ready/eae-info-circle.skin1", a), elementorFrontend.hooks.addAction("frontend/element_ready/eae-info-circle.skin2", a), elementorFrontend.hooks.addAction("frontend/element_ready/eae-info-circle.skin3", a), elementorFrontend.hooks.addAction("frontend/element_ready/eae-info-circle.skin4", a), elementorFrontend.hooks.addAction("frontend/element_ready/eae-timeline.skin1", t), elementorFrontend.hooks.addAction("frontend/element_ready/eae-timeline.skin2", t), elementorFrontend.hooks.addAction("frontend/element_ready/eae-timeline.skin3", t), elementorFrontend.hooks.addAction("frontend/element_ready/eae-timeline.skin4", t), elementorFrontend.hooks.addAction("frontend/element_ready/eae-evergreen-timer.skin1", (function(e, a) {
            ...
            if (!e.hasClass("elementor-element-edit-mode"))
                if ("countdown" === s) {
                    ...
                    var m = n(d),
                        u = "";
                    if ("" !== m) {
                        (u = new Date(parseInt(m))).setSeconds(u.getSeconds() + e.find(".eae-evergreen-wrapper").data("egtime")), t = u.getTime();
                        var h = new Date(parseInt(m));
                        h.setTime(h.getTime() + 60 * r * 60 * 1e3);
                        var g = "expires=" + h.toUTCString();
                        document.cookie = d + "=" + m + ";" + g + ";path=/";
                        var w = new Date(parseInt(m));
                        w.setTime(w.getTime() + 1e3 * e.find(".eae-evergreen-wrapper").data("egtime"));
                        f = "expires=" + w.toUTCString();
                        t - p > 0 && (document.cookie = o + "=" + m + ";" + f + ";path=/")
                    } else {
                        temp_date = t, (u = new Date).setSeconds(u.getSeconds() + e.find(".eae-evergreen-wrapper").data("egtime")), t = u.getTime(), i(d, (new Date).getTime(), r);
                        var v = new Date;
                        v.setTime(v.getTime() + 1e3 * temp_date);
                        var y = "expires=" + v.toUTCString();
                        document.cookie = o + "=" + (new Date).getTime() + ";" + y + ";path=/"
                    }
                }
            if (!e.hasClass("elementor-element-edit-mode") && t - p < 0) return l.length > 0 && l.forEach((function(t) {
                "redirect" === t && ($url = e.find(".eae-evergreen-wrapper").data("redirected-url"), "" !== a.trim($url) && (window.location.href = $url1)), "hide" === t && (e.hasClass("elementor-element-edit-mode") || (e.find("#eaeclockdiv").css("display", "none"), e.find(".egt-title").css("display", "none"))), "message" === t && e.find(".eae-egt-message").css("display", "block"), "hide_parent" === t && (e.hasClass("elementor-element-edit-mode") || ($p_secs = e.closest("section"), $p_secs.css("display", "none")))
            ...
            e.hasClass("elementor-element-edit-mode") && ("countdown" === s ? (u = new Date(t), t = u.getTime()) : ((u = new Date).setSeconds(u.getSeconds() + e.find(".eae-evergreen-wrapper").data("egtime")), t = u.getTime()));
            var b = setInterval((function() {
                var i = (new Date).getTime(),
                    ...
                    d = 0,
                    o = 0;
                n > 0 ? (r = Math.floor(n / 864e5), s = "0" + Math.floor(n % 864e5 / 36e5), d = "0" + Math.floor(n % 36e5 / 6e4), o = "0" + Math.floor(n % 6e4 / 1e3)) : (l.length > 0 && (e.hasClass("elementor-element-edit-mode") || l.forEach((function(t) {
                ...
                }))), clearInterval(b), r = "0", s = "00", d = "00", o = "00"), r < 10 && (r = "0" + r), e.find("." + c).find("#eaedivDays").html(r), e.find("." + c).find("#eaedivHours").html(s.slice(-2)), e.find("." + c).find("#eaedivMinutes").html(d.slice(-2)), e.find("." + c).find("#eaedivSeconds").html(o.slice(-2))
            }), 1e3)
        })), elementorFrontend.hooks.addAction("frontend/element_ready/eae-evergreen-timer.skin2", (function(e, a) {
            var t = e.find(".eae-evergreen-wrapper").data("egtime"),
                r = e.find(".eae-evergreen-wrapper").data("egt-expire"),
                s = e.find(".eae-evergreen-wrapper").data("element-type"),
                d = "eae-" + e.find(".eae-evergreen-wrapper").data("id"),
            ...
            if (!e.hasClass("elementor-element-edit-mode") && t - p < 0) return void(l.length > 0 && l.forEach((function(t) {
            ...
            var b = setInterval((function() {
                var i = (new Date).getTime(),
                    ...
                    d = Math.floor(n % 36e5 / 6e4),
                    o = Math.floor(n % 6e4 / 1e3);
                if (e.find("." + c).find("#eaeulSec1").find(".flip-clock-active").removeClass("flip-clock-active"), e.find("." + c).find("#eaeulSec1").find(".flip-clock-before").removeClass("flip-clock-before"), e.find("." + c).find("#eaeulSec").find(".flip-clock-active").removeClass("flip-clock-active"), e.find("." + c).find("#eaeulSec").find(".flip-clock-before").removeClass("flip-clock-before"), n < 0) return clearInterval(b), void(l.length > 0 && l.forEach((function(t) {
                ...
                if (2 === a.trim(o).length) {
                    ...
                    p = "#eaeulSec1 li:eq( " + a.trim(o).charAt(0) + " )", f = "#eaeulSec li:eq( 0 )";
                    e.find("." + c).find(p).next().length > 0 ? (e.find("." + c).find(p).addClass("flip-clock-active"), e.find("." + c).find(p).next().addClass("flip-clock-before")) : (e.find("." + c).find("#eaeulSec1 li:last-child").addClass("flip-clock-active"), e.find("." + c).find("#eaeulSec1 li:first-child").addClass("flip-clock-before")), e.find("." + c).find(f).next().length > 0 ? (e.find("." + c).find(f).addClass("flip-clock-active"), e.find("." + c).find(f).next().addClass("flip-clock-before")) : (e.find("." + c).find("#eaeulSec li:last-child").addClass("flip-clock-active"), e.find("." + c).find("#eaeulSec li:first-child").addClass("flip-clock-before"))
                }
                if (e.find("." + c).find("#eaeulMin1").find(".flip-clock-active").removeClass("flip-clock-active"), e.find("." + c).find("#eaeulMin1").find(".flip-clock-before").removeClass("flip-clock-before"), e.find("." + c).find("#eaeulMin").find(".flip-clock-active").removeClass("flip-clock-active"), e.find("." + c).find("#eaeulMin").find(".flip-clock-before").removeClass("flip-clock-before"), 2 == a.trim(d).length) {
                    p = "#eaeulMin1 li:eq( " + a.trim(d).charAt(1) + " )", f = "#eaeulMin li:eq( " + a.trim(d).charAt(0) + " )";
                ...
                if (e.find("." + c).find("#eaeulHour1").find(".flip-clock-active").removeClass("flip-clock-active"), e.find("." + c).find("#eaeulHour1").find(".flip-clock-before").removeClass("flip-clock-before"), e.find("." + c).find("#eaeulHour").find(".flip-clock-active").removeClass("flip-clock-active"), e.find("." + c).find("#eaeulHour").find(".flip-clock-before").removeClass("flip-clock-before"), 2 == a.trim(s).length) {
                    ...
                    p = "#eaeulHour1 li:eq( " + a.trim(s).charAt(0) + " )", f = "#eaeulHour li:eq( 0 )";
                ...
                if (e.find("." + c).find("#eaeulDay1").find(".flip-clock-active").removeClass("flip-clock-active"), e.find("." + c).find("#eaeulDay1").find(".flip-clock-before").removeClass("flip-clock-before"), e.find("." + c).find("#eaeulDay").find(".flip-clock-active").removeClass("flip-clock-active"), e.find("." + c).find("#eaeulDay").find(".flip-clock-before").removeClass("flip-clock-before"), 2 == a.trim(r).length) {
                    p = "#eaeulDay1 li:eq( " + a.trim(r).charAt(1) + " )", f = "#eaeulDay li:eq( " + a.trim(r).charAt(0) + " )";
                    ...
                    p = "#eaeulDay1 li:eq( " + a.trim(r).charAt(0) + " )", f = "#eaeulDay li:eq( 0 )";
        ...
        })), elementorFrontend.hooks.addAction("frontend/element_ready/eae-evergreen-timer.skin3", (function(e, a) {
            var t, r = e.find(".eae-evergreen-wrapper").data("egtime"),
            ...
            if (!e.hasClass("elementor-element-edit-mode"))
                if ("countdown" === d) {
                    ...
                    var w = "expires=" + y.toUTCString();
                    document.cookie = l + "=" + y.getTime() + ";" + w + ";path=/"
                } else {
                    var v = n(o),
                        y = "";
                    if ("" !== v) {
                        (y = new Date(parseInt(v))).setSeconds(y.getSeconds() + e.find(".eae-evergreen-wrapper").data("egtime")), r = y.getTime();
                        ...
                        C.setTime(C.getTime() + 1e3 * e.find(".eae-evergreen-wrapper").data("egtime"));
                        w = "expires=" + C.toUTCString();
                        r - g > 0 && (document.cookie = l + "=" + v + ";" + w + ";path=/")
                    } else {
                        temp_date = r, (y = new Date).setSeconds(y.getSeconds() + e.find(".eae-evergreen-wrapper").data("egtime")), r = y.getTime(), i(o, (new Date).getTime(), s);
                        var _ = new Date;
            ...
            if (!e.hasClass("elementor-element-edit-mode")) {
                var x = D(r);
                if (parseInt(x.all) < 1) {
                    if (c.length > 0 && (c.forEach((function(a) {
                            "redirect" === a && (e.hasClass("elementor-element-edit-mode") || ($url = e.find(".eae-evergreen-wrapper").data("redirected-url"), "" !== $url && (window.location.href = $url))), "hide_parent" === a && (e.hasClass("elementor-element-edit-mode") || ($p_secs = e.closest("section"), $p_secs.css("display", "none"))), "hide" === a && (e.find("#timer").css("display", "none"), e.find(".egt-title").css("display", "none"), e.find(".desc").css("display", "none")), "message" === a && e.find(".eae-egt-message").css("display", "block")
                        })), 1 === c.length && ("" === c[0] || "message" === c[0]))) {
                        var $ = e.find("." + h).find("#timer")[0];
                        "yes" === p && ($.innerHTML = "<span class='egt-time eae-time-wrapper'><div>00</div></span>"), "yes" === f && ("yes" === p ? a($).append("<span class='egt-time eae-time-wrapper'><div>00</div></span>") : $.innerHTML = "<span class='egt-time eae-time-wrapper'><div>00</div></span>"), "yes" === m && ("yes" === p || "yes" === f ? a($).append("<span class='egt-time eae-time-wrapper'><div>00</div></span>") : $.innerHTML = "<span class='egt-time eae-time-wrapper'><div>00</div></span>"), "yes" === u && ("yes" === p || "yes" === f || "yes" === m ? a($).append("<span class='egt-time eae-time-wrapper'><div>00</div></span>") : $.innerHTML = "<span class='egt-time eae-time-wrapper'><div>00</div></span>")
                    }
                    return
                }
            }
            ...
            e.hasClass("elementor-element-edit-mode") && ("countdown" === d ? (y = new Date(r), r = y.getTime()) : ((y = new Date).setSeconds(y.getSeconds() + e.find(".eae-evergreen-wrapper").data("egtime")), r = y.getTime())), D(r).all > 1 && (t = setInterval((function() {
                var i = e.find("." + h).find("#timer")[0],
                    n = D(r);
                "yes" === p && (n.days < 10 && (n.days = "0" + n.days), i.innerHTML = "<span class='egt-time eae-time-wrapper'><div>" + n.days + "</div></span>"), "yes" === f && ("yes" === p ? a(i).append("<span class='egt-time eae-time-wrapper'><div>" + n.hours.slice(-2) + "</div></span>") : i.innerHTML = "<span class='egt-time eae-time-wrapper'><div>" + n.hours.slice(-2) + "</div></span>"), "yes" === m && ("yes" === p || "yes" === f ? a(i).append("<span class='egt-time eae-time-wrapper'><div>" + n.minutes.slice(-2) + "</div></span>") : i.innerHTML = "<span class='egt-time eae-time-wrapper'><div>" + n.minutes.slice(-2) + "</div></span>"), "yes" === u && ("yes" === p || "yes" === f || "yes" === m ? a(i).append("<span class='egt-time eae-time-wrapper'><div>" + n.seconds.slice(-2) + "</div></span>") : i.innerHTML = "<span class='egt-time eae-time-wrapper'><div>" + n.seconds.slice(-2) + "</div></span>");
                var s = i.getElementsByTagName("span");
                "yes" === p && 59 == n.hours && 59 == n.minutes && 59 == n.seconds && S(s[0]), "yes" === f && ("yes" === p ? 59 == n.minutes && 59 == n.seconds && S(s[1]) : 59 == n.minutes && 59 == n.seconds && S(s[0])), "yes" === m && ("yes" === p ? "yes" === f ? 59 == n.seconds && S(s[2]) : 59 == n.seconds && S(s[1]) : "yes" === f ? 59 == n.seconds && S(s[1]) : 59 == n.seconds && S(s[0])), "yes" === u && ("yes" === p ? "yes" === f ? "yes" === m && S(s[3]) : S("yes" === m ? s[2] : s[1]) : "yes" === f ? "yes" === m && S(s[2]) : S("yes" === m ? s[1] : s[0])), n.all <= 1 && (clearInterval(t), "yes" === p && (i.innerHTML = "<span class='egt-time eae-time-wrapper'><div>00</div></span>"), "yes" === f && ("yes" === p ? a(i).append("<span class='egt-time eae-time-wrapper'><div>00</div></span>") : i.innerHTML = "<span class='egt-time eae-time-wrapper'><div>00</div></span>"), "yes" === m && ("yes" === p || "yes" === f ? a(i).append("<span class='egt-time eae-time-wrapper'><div>00</div></span>") : i.innerHTML = "<span class='egt-time eae-time-wrapper'><div>00</div></span>"), "yes" === u && ("yes" === p || "yes" === f || "yes" === m ? a(i).append("<span class='egt-time eae-time-wrapper'><div>00</div></span>") : i.innerHTML = "<span class='egt-time eae-time-wrapper'><div>00</div></span>"), e.hasClass("elementor-element-edit-mode") || c.length > 0 && c.forEach((function(a) {
                    "redirect" === a && ($url1 = e.find(".eae-evergreen-wrapper").data("redirected-url"), "" !== $url1 && (window.location.href = $url1)), "hide" === a && (e.find("#timer").css("display", "none"), e.find(".egt-title").css("display", "none"), e.find(".desc").css("display", "none")), "message" === a && e.find(".eae-egt-message").css("display", "block"), "hide_parent" === a && ($p_secs = e.closest("section"), $p_secs.css("display", "none"))
                })))
            }), 1e3))
        })), elementorFrontend.hooks.addAction("frontend/element_ready/eae-comparisontable.default", (function(e, a) {
            a(e.find(".eae-ct-heading")[0]).addClass("active"), e.find("ul").on("click", "li", (function() {
                var t = a(this).index() + 2;
                e.find("tr").find("td:not(:eq(0))").hide(), e.find("td:nth-child(" + t + ")").css("display", "table-cell"), e.find("tr").find("th:not(:eq(0))").hide(), e.find("li").removeClass("active"), a(this).addClass("active")
            }));
            var t = window.matchMedia("(min-width: 767px)");

            function i(a) {
                a.matches ? e.find(".sep").attr("colspan", 5) : e.find(".sep").attr("colspan", 2)
            }
            t.addListener(i), i(t)
        })), elementorFrontend.hooks.addAction("frontend/element_ready/eae-progress-bar.skin1", r), elementorFrontend.hooks.addAction("frontend/element_ready/eae-progress-bar.skin2", r), elementorFrontend.hooks.addAction("frontend/element_ready/eae-progress-bar.skin3", r), elementorFrontend.hooks.addAction("frontend/element_ready/eae-progress-bar.skin4", r), elementorFrontend.hooks.addAction("frontend/element_ready/eae-progress-bar.skin5", r), elementorFrontend.hooks.addAction("frontend/element_ready/eae-filterableGallery.default", (function(e, a) {
            ...
            if (d = "x" === d ? "y" : "y" === d ? "x" : "both", "yes" === o) var c = t.attr("data-max-glare");
            o = "yes" === o;
            var p = a(".elementor-element-" + i + " .eae-fg-image"),
            ...
            m.imagesLoaded().progress((function() {
                ...
                glare: o,
                maxGlare: c
            }, e.find(".el-tilt").tilt(atilt)), a(".elementor-element-" + i + " .eae-gallery-filter a").on("click", (function() {
                e.find(".eae-gallery-filter .current").removeClass("current"), a(this).addClass("current");
                var t = a(this).attr("data-filter");
                adata.filter = t;
                var i = p.isotope(adata);
                return i.imagesLoaded().progress((function() {
            ...
            })), t.hasClass("eae-hover-direction-effect") || e.find(".eae-gallery-item-inner").hover((function() {
                a(this).find(".eae-grid-overlay").addClass("animated")
            })), t.hasClass("eae-hover-direction-effect") && (e.find(".eae-gallery-item-inner").hover((function() {
                a(this).find(".eae-grid-overlay").addClass("overlay")
            })), t.find(".eae-gallery-item-inner").EAEHoverDirection({
                speed: l
            }))
        })), elementorFrontend.hooks.addAction("frontend/element_ready/eae-content-switcher.skin1", s), elementorFrontend.hooks.addAction("frontend/element_ready/eae-content-switcher.skin2", s), elementorFrontend.hooks.addAction("frontend/element_ready/eae-content-switcher.skin3", d), elementorFrontend.hooks.addAction("frontend/element_ready/eae-content-switcher.skin4", d), elementorFrontend.hooks.addAction("frontend/element_ready/global", (function(e, a) {
            isEditMode || e.data("wts-url") && "yes" == e.data("wts-link") && e.on("click", (function(a) {
                e.data("wts-url") && "yes" == e.data("wts-new-window") ? window.open(e.data("wts-url")) : location.href = e.data("wts-url")
            }))
        })), elementorFrontend.hooks.addAction("frontend/element_ready/eae-thumbgallery.default", (function(e, a) {
            ...
            s[r.lg - 1] = {
                ...
                spaceBetween: n.desktop
            }, s[r.md - 1] = {
                slidesPerView: i.tablet,
                spaceBetween: n.tablet
            };
            const d = eae.breakpoints;
            let o = {};
            if (o[d.lg - 1] = {
                    spaceBetween: t.spaceBetween.desktop
                }, o[d.md - 1] = {
                    spaceBetween: t.spaceBetween.tablet
                }, sliderData = {
                ...
                }, void 0 !== t.autoplay && (sliderData.thumbs.swiper.autoplay = {
                ...
                }), "yes" == t.navigation && (sliderData.navigation = {
                    nextEl: wClass + " .eae-swiper-button-next",
                    prevEl: wClass + " .eae-swiper-button-prev"
                }), "" !== t.pagination && (sliderData.pagination = {
                    type: t.pagination,
                    el: wClass + " .swiper-pagination",
                    clickable: t.clickable
                }), void 0 !== t.autoplay && (sliderData.autoplay = {
                    delay: t.autoplay.duration,
                    disableOnInteraction: t.autoplay.disableOnInteraction,
                    reverseDirection: t.autoplay.reverseDirection
            ...
            } else window.sswiper = new Swiper(".elementor-element-" + wid + " .eae-swiper-outer-wrapper .eae-swiper-container", sliderData), a(".elementor-element-" + wid + " .eae-swiper-outer-wrapper .eae-swiper-container").css("visibility", "visible");
            if (void 0 !== t.autoplay) {
                "yes" == t.autoplay.pauseOnHover && jQuery(wClass + " .eae-swiper-container").hover((function() {
                    sswiper.autoplay.stop(), sswiper.thumbs.swiper.autoplay.stop()
                }), (function() {
                    sswiper.autoplay.start(), sswiper.thumbs.swiper.autoplay.start()
                }))
            }
        })), elementorFrontend.hooks.addAction("frontend/element_ready/eae-chart.bar", o), elementorFrontend.hooks.addAction("frontend/element_ready/eae-chart.horizontalBar", o), elementorFrontend.hooks.addAction("frontend/element_ready/eae-chart.line", o), elementorFrontend.hooks.addAction("frontend/element_ready/eae-data-table.default", (function(e, a) {
            const t = e.find(".eae-table"),
                i = e.find(".eae-table-container");
            lottie_class = e.find(".eae-lottie"), settings = t.data("settings"), lottie_class.each((function() {
            ...
            })), !0 === settings.sort ? (head_class = a(".eae-table thead tr:not(:last-child)").addClass("eae-sort__ignoreRow"), t.tablesorter({
                sortReset: !1,
                sortRestart: !0
            })) : head_class = a(".eae-table thead tr:not(:last-child)").removeClass("eae-sort__ignoreRow"), settings.search && i.find("#eae-searchable").keyup((function() {
                _this = this, t.find(".eae-table__body tr").each((function() {
                    -1 === a(this).text().toLowerCase().indexOf(a(_this).val().toLowerCase()) ? a(this).addClass("eae-table-search-hide") : a(this).removeClass("eae-table-search-hide")
                }))
            }))
        })), elementorFrontend.hooks.addAction("frontend/element_ready/CfStyler.default", (function(e, a) {
            if (e.hasClass("elementor-element-edit-mode") && a("#error-field-hidden").hasClass("validation-field-box")) {
                e.find(".wpcf7-validates-as-required").parent().append("<p class='error-field'>The field is required.</p>")
            }
        })), elementorFrontend.hooks.addAction("frontend/element_ready/eae-anythingcarousel.default", (function(e, a) {
            const t = e.find(".eae-swiper-outer-wrapper"),
                i = e.data("id"),
                n = t.data("swiper-settings");
            l(n, i, e, t)
        }))
    }))
}(jQuery);