    ...
    function a(e) {
        ...
        if (e.parents(".eae-at-animation").hasClass("type")) {
            ...
            o.addClass("selected").removeClass("waiting"), setTimeout((function() {
                ...
                ! function(e, i) {
                    e.parents(".eae-at-animation").hasClass("type") && (t(e.find("i").eq(0), e, !1, i), e.addClass("is-visible").removeClass("is-hidden"))
                }(i, 150)
            }), 1300)
        } else if (e.parents(".eae-at-animation").hasClass("letters")) {
            var l = e.children("i").length >= i.children("i").length;
            ! function e(i, t, o, l) {
                i.removeClass("in").addClass("out"), i.is(":last-child") ? o && setTimeout((function() {
                    a(s(t))
                }), 2500) : setTimeout((function() {
                    e(i.next(), t, o, l)
                }), l);
                if (i.is(":last-child") && jQuery("html").hasClass("no-csstransitions")) {
                    var r = s(t);
                    n(t, r)
                }
            }(e.find("i").eq(0), e, l, 50), t(i.find("i").eq(0), i, l, 50)
        } else n(e, i), setTimeout((function() {
            a(i)
        }), 2500)
    }
