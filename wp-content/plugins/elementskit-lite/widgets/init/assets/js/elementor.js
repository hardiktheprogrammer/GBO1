! function(e, t) {
    ...
    window.ElementsKit_Helper = {}, ElementsKit_Helper.setURLHash = function(t, n, i) {
        ...
        i.length && !t.hasClass("ekit-ajax-loading") && e.ajax({
            ...
            beforeSend: function() {
                t.addClass("ekit-ajax-loading"), n.toggleClass("icon icon-down-arrow1 eicon-loading eicon-animation-spin"), e(document).width() <= Number(a) ? n.css({
                    border: "none"
                }) : n.css({
                    "padding-right": 0,
                    "margin-right": "5px"
            ...
            success: function(a) {
                t.removeClass("ekit-ajax-loading"), i.replaceWith(a), n.toggleClass("eicon-loading eicon-animation-spin icon icon-down-arrow1").removeAttr("style"), t.find(".elementor-element").each((function() {
    ...
    let n = {
        ...
        Image_Accordion: function(t) {
            ...
            t.on("click", ".ekit-image-accordion-item", (function(t) {
                let n = e(this),
                    ...
                    o = n.find("a, a *"),
                    l = e(t.target).is(o),
                    r = a ? .is_external ? a.is_external : "_self";
                if ("hover" === s || i === this) !l && a ? .url && window.open(a.url, r);
                else {
                    ...
                    if (n.hasClass("item-opened")) return void(!l && a ? .url && window.open(a.url, r))
                }
            }))
        },
        Nav_Menu: function(t) {
            if (t.find(".elementskit-megamenu-has").length > 0) {
                let n = t.find(".ekit-wid-con").data("responsive-breakpoint"),
                    ...
                    a = t.find(".elementskit-menu-container").outerHeight();
            ...
            if (t.find(".ekit-nav-dropdown-click").length > 0) {
                ...
                t.on("click", ".elementskit-dropdown-has > a", (function(i) {
                    ...
                    let a = e(this).parent(),
                        ...
                        o = a.find(">.elementskit-dropdown, >.elementskit-megamenu-panel");
        ...
        Progressbar: function(e) {
            ...
            t.elementorWaypoint((function() {
                i.animateNumbers(a, !0, s), n.animate({
                    width: a + "%"
                }, s)
            }), {
                offset: "100%"
        ...
        Funfact: function(e) {
            var t = e.find(".elementskit-funfact"),
                ...
                i = n.data("value"),
                a = n.data("animation-duration") || 300;
            t.elementorWaypoint((function() {
                n.animateNumbers(i, !0, a)
            }), {
                offset: "100%"
            })
        },
        ...
        Countdown_Timer: function(t) {
            var n = t.find(".ekit-countdown"),
                i = n.data(),
                a = "elementskit-inner-container ekit-countdown-inner",
            ...
            if (n.length) {
                switch (n[0].classList[0]) {
                    ...
                    default:
                        i.markup = '<div class="elementskit-timer-container elementskit-days"><div class="' + a + '"><div class="elementskit-timer-content"><span class="elementskit-timer-count">%-D </span><span class="elementskit-timer-title">' + i.dateEkitDay + '</span></div></div></div><div class="elementskit-timer-container elementskit-hours"><div class="' + a + '"><div class="elementskit-timer-content"><span class="elementskit-timer-count">%H </span><span class="elementskit-timer-title">' + i.dateEkitHour + '</span></div></div></div><div class="elementskit-timer-container elementskit-minutes"><div class="' + a + '"><div class="elementskit-timer-content"><span class="elementskit-timer-count">%M </span><span class="elementskit-timer-title">' + i.dateEkitMinute + '</span></div></div></div><div class="elementskit-timer-container elementskit-seconds"><div class="' + a + '"><div class="elementskit-timer-content"><span class="elementskit-timer-count">%S </span><span class="elementskit-timer-title">' + i.dateEkitSecond + "</span></div></div></div>";
                        break;
                    case "elementskit-countdown-timer-3":
                        i.markup = '<div class="elementskit-timer-container elementskit-days"><div class="' + o + '"><div class="' + s + '"><span class="elementskit-timer-count">%-D </span><span class="elementskit-timer-title">' + i.dateEkitDay + '</span></div></div></div><div class="elementskit-timer-container elementskit-hours"><div class="' + o + '"><div class="' + s + '"><span class="elementskit-timer-count">%H </span><span class="elementskit-timer-title">' + i.dateEkitHour + '</span></div></div></div><div class="elementskit-timer-container elementskit-minutes"><div class="' + o + '"><div class="' + s + '"><span class="elementskit-timer-count">%M </span><span class="elementskit-timer-title">' + i.dateEkitMinute + '</span></div></div></div><div class="elementskit-timer-container elementskit-seconds"><div class="' + o + '"><div class="' + s + '"><span class="elementskit-timer-count">%S </span><span class="elementskit-timer-title">' + i.dateEkitSecond + "</span></div></div></div>"
                }
            ...
            if (l.length) {
                ...
                let i = l.children(".elementskit-mins"),
                    a = l.children(".elementskit-secs"),
                    s = l.children(".elementskit-hrs"),
                ...
                l.theFinalCountdown(r.ekitCountdown, (function(e) {
                    m(c.s, e.offset.seconds, a), m(c.m, e.offset.minutes, i), m(c.h, e.offset.hours, s), m(c.d, e.offset.days, o), m(c.w, e.offset.weeks, d), c.s = e.offset.seconds, c.m = e.offset.minutes, c.h = e.offset.hours, c.d = e.offset.days, c.w = e.offset.weeks
                })).on("finish.countdown", (function() {
        ...
        PostTab: function(t) {
            ...
            t.on(n, ".tab__list__item", (function() {
                var t = e(this),
                    n = a.eq(t.index());
                i.add(a).removeClass("active"), t.add(n).addClass("active")
            }))
        },
...
function(e) {
    "use strict";
    e.fn.animateNumbers = function(t, n, i, a) {
        return this.each((function() {
            var s = e(this),
                o = parseInt(s.text().replace(/,/g, ""), 10);
            n = n === undefined || n, e({
                value: o
            }).animate({
                value: t
                ...
                easing: a === undefined ? "swing" : a,
                step: function() {
                    s.text(Math.floor(this.value)), n && s.text(s.text().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,"))
                },
                complete: function() {
                    parseInt(s.text(), 10) !== t && (s.text(t), n && s.text(s.text().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,")))
                }
            })
        }))
        ...
        return this.easyPieChart({
            barColor: !0 === n.gradientChart ? function(e) {
                ...
                return a.addColorStop(0, n.gradientColor1), a.addColorStop(1, n.gradientColor2), a
            } : n.barColor,
